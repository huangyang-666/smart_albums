  ...
  <div class="bg">
    ...
    <div class="login-box1">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px;" class="login-box">
        ...
        <el-form-item label=" " prop="pwdtwo"><h2>确认密码</h2>
          <el-input type="password" placeholder="请再次输入密码" v-model="form.pwdtwo"/>
        </el-form-item>
        ...
        <el-form-item class="login-button">
          ...
          <div class="zc">
            ...
            <el-button type="primary" plain @click="gotolink()">登录</el-button>
          </div>
        </el-form-item>
      </el-form>
    </div>
