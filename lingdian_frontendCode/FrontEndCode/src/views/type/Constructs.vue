              ...
              <div class="left">
                <el-col :span="5" v-for="(o, index) in 1" :key="o" :offset="index > 0 ? 4 : 0">
                  <el-image
                    ...
                    :src="'../../../static/smart_photos/constructs/'+item.name"
                    :preview-src-list="['../../../static/smart_photos/constructs/'+item.name]"
                    :fit="fit"></el-image>
                </el-col>
              </div>
              <!--            </div>-->
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.param.append('type',"5");
      const _this = this;
      axios.post('http://localhost:8086/diftypedisplay',_this.param,{
        headers:{
